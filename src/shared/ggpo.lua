...
function InputQueue_new<I,J>(gameConfig : GameConfig<I,J>, owner : PlayerHandle, player: PlayerHandle, startFrame : Frame, currentFrame : Frame, frame_delay : FrameCount) : InputQueue<I,J>
